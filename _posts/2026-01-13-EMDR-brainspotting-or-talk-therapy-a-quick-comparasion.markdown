...
![Compare EMDR, BrainSpotting, and talk therapy](/assets/img/compare-emdr-brainspotting-therapy.jpg "A person on a chair in a room" )

<div class="intro-blog">Finding the right therapy for you can feel a bit like trying to find the best street food. There are endless options, but you really want something that’s going to agree with you. If you’ve spent the last hour searching for therapy in Mexico City, you’ve likely noticed a few terms popping up: EMDR, Brainspotting, and good old-fashioned Talk Therapy.</div>

<div class="intro-blog">I’m a psychologist based in Condesa, and I know that "mental health" isn't a one-size-fits-all deal. Sometimes you need to talk things through, and sometimes your brain needs a different kind of "reset." Here is a look at how these three approaches actually work.</div>
...
* **What the research says:** According to the [American Psychological Association (APA)](https://www.apa.org/topics/psychotherapy/understanding), the "therapeutic alliance" (basically, how well you and your therapist get along) is often a bigger predictor of success than the specific method used.
...
* **What the research says:** The [National Institutes of Health (NIH)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3951033/) recognizes EMDR as a highly effective way to treat PTSD. It’s proven to help people "file away" traumatic memories that previously felt unmanageable.
...
* **What the research says:** While it’s newer than EMDR, [preliminary studies](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10300018/) suggest it’s excellent for things like anxiety and "stuckness" that don't respond well to just talking.
...
**Want to see what feels right for you?** Choosing a therapist is a big decision, and the "vibe" matters. I offer a [free 15-minute consultation so we can chat ](https://zcal.co/mindbodycacao/consultation), see if we click, and figure out which of these paths makes the most sense for where you are right now. 


![EMDR, BrainSpotting, and talk therapy comparasion table infographic](/assets/img/emdr-brainspotting-therapy-psychotherapy-infographic-mexico.png "EMDR, BrainSpotting, and talk therapy comparasion table infographic" )
