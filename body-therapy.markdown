            ...
            <div class="inside-container">
                ...
                <div class="thin-box-no-click p-5 my-5">
                        ...
                        <ul class="page-service-list">
                            ...
                            <li>Depression, low energy, and emotional numbness</li>
                            <li>Trauma, chronic tension, and nervous system overwhelm</li>
                            <li>Difficult emotions that feel “stuck” or hard to express</li>
                            <li>Relationship challenges and patterns that show up physically</li>
                            <li>Life transitions, identity shifts, and periods of uncertainty</li>
                            <li>Grief, loss, and emotional heaviness held in the body</li>
                            <li>Cultural adjustment, homesickness, and grounding in a new place</li>
                            <li>Somatic symptoms related to stress, fear, or unprocessed experiences</li>
                        </ul>
                </div>
            </div>
        <div class="inside-container ">
                ...
                <p>Below is an overview of the therapeutic approaches used in sessions. Your treatment plan is always personalized, these modalities can be used individually or combined depending on your needs - including with the body movement therapy or other therapies.</p>
                    <div class="page-services-explanation">
                        <ul>
                            <li>
                                <h3>Yoga Therapy</h3>
                                <p>Yoga therapy blends mindful movement, breathwork, and grounding practices to help regulate your nervous system and create a sense of safety and steadiness inside your body.</p>
